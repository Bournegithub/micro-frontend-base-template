export const userListTableCloumns = [
	{ label: 'id', prop: 'id', width: '180px' },
	{ label: 'nickName', prop: 'nickName', width: '120px' },
	{ label: 'realName', prop: 'realName', width: '120px' },
	{ label: 'mail', prop: 'mail', width: '180px' },
	{ label: 'phone', prop: 'phone', width: '120px' },
